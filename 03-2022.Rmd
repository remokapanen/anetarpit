...
- 7. iskun ja tämän jälkeen joka toisen painelusyklin (2min painelua ja rytmintarkastus ja tarvittaessa isku) jälkeen adrenaliini 1mg
...
- Jatkossa elvytyksen aikana adrenaliinia annetaan joka toinen painelusykli
...
ROSC = spontaanin verenkierron palautuminen (return of spontaneous circulation) elvytyksessä
...
## Minkä tyypin lääke amiodaroni on? 
...
## Minkä sokkityypin sokki sydäntamponaatio on?
...
Grammoina n. 3,5g (miehille suositus; naisille n. 3100mg/vrk; tietysti suositukset hieman vaihtelevat painon mukaan)

Tietysti suositukset hieman vaihtelevat painon mukaan. Useissa lähteissä on mainittu tarve 1mmol/kg/vrk (1 mmol = 39.1g) ja tästä laskien esim. 50kg potilas tarvitsee n. 2g kaliumia päivässä. 
  </div>
</div>
...
Nykyään käytetään yleensä lääkestenttejä ja niiden yhteydessä DAPT (kaksoishiutaleenestäjälääkitystä eli ASA + P2Y12-estäjä, kuten klopidogreeli) tyypillisesti n. 12kk ajan, ja DAPT on äärettömän tärkeää estämään stenttitromboosia. 
...
- Seurataan kipua, tajuntaa ja orientaatiota, pahoinvointia, haavan tilannetta, dreenivuotoa, diureesia, kognition toipumista
  - Hemodynamiikan lievä labiilius, niukka diureesi ja shivering-tyyppinen tärinä ovat tavallisia ongelmia heräämöhoidon aikana
- Potilaan psyykkistä tilaa seurataan; leikkausta edeltävä jännitys voi joskus purkautua psyykkisenä ahdistuksena heräämövaiheessa, ja joskus leikkauksessa on selvinnyt sairauden huono ennuste

Seuranta-aika heräämössä vaihtelee potilaittain ja leikkauksittain 0 min:sta (perifeerinen puudutus, ei sedaatiota) jopa yön yli (esim. elektiivinen kraniotomia)
