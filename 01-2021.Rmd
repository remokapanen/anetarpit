...
Tarkoittaa siis alveolipainetta uloshengityksen loppuvaiheessa. Tämä pidetään positiivisena esim. antamalla CPAP-laitteella jatkuvasti ilmavirtaa paineella keuhkoihin, mikä pitää alveolit auki. 
  </div>
</div>
...
Esim. kipulääke (paracetamol, NSAID, opioidit), pahoinvointia ehkäisevä lääke (ondansetron (yleensä leikkauksen loputtua), betametasoni (yleensä ennen leikkausta pahoinvoinnin estoon)), antibioottiprofylaksia (metronidatsoli esim), puudutukset (esim. bupivakaiini spinaalipuudutteena), rauhoittavat lääkkeet (esim. midatsolaami) 
  </div>
</div>
...
## Mitä haasteita/virhelähteitä pulssioksimetrissä on?
...
Anafylaksian hoito perustuu adrenaliinin annosteluun. Anafylaksiassa adrenaliinia voidaan annostella i.v. (vain sokissa) tai i.m. Annostelu on iv:sti aikuisille 0,05-0,1mg ja i.m:sti 0,3-0,5 mg. Lapsille im-annostelu on 0,01 mg/kg.
  </div>
</div>
...
Jos olet unohtanut hyponatremiasta perusteet ja miksi mikäkin tila aiheuttaa hyponatremiaa ja miksi mikäkin hoito auttaa eri tilanteissa (eikä vain anneta suolatabletteja), niin kannattaa lukea [tästä kirjasta](https://www.dropbox.com/scl/fi/su5a80q9gb3ize0tn85z3/The-whole-enchilada.pdf?rlkey=89f8gpkgek0ibknywv4qjsugb&e=3&dl=0) hyponatremia-osuudet. 
...
Muita vasta aiheita ovat kohonnut kallonsisäinen paine, samoin aktiivinen antikoagulaatiohoito (ei haittaa, että pieniannos-ASA on päällä, mutta muuten käytännössä kaikki antitromboottiset/antikoagulatiiviset lääkkeet tulee tauottaa joksikin aikaa ennen sentraalista puudutusta (vaihtelee lääkkeen mukaan))
